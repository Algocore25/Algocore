...
export default function PublicProfilePage() {
    ...
    if (state === "notfound") return <ErrorScreen emoji="🔍" title="User not found" desc="No profile exists for" username={username} onHome={() => router.push("/")} />;
    if (state === "private") return <ErrorScreen emoji="🔒" title="Private Profile" desc="This profile is private." username={username} onHome={() => router.push("/")} />;
