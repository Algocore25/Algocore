        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center space-x-4">
                    <button onClick={() => router.push('/admin')} className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">
                        <FiArrowLeft size={24} />
                    </button>
                            ...
                            <div className="space-y-2">
                                {uploadResults.successful.map((result, index) => (
                                    <div key={index} className="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md">
                                        ...
                                        <button
                                            onClick={() => router.push(`/courseedit/${result.courseId}?index=${result.index}`)}
