import { Clock, AlertTriangle, Users, TrendingUp, Smartphone } from 'lucide-react';
...
export const StatsPanel = ({ status }) => {
  ...
  const stats = [
    ...
    {
      label: 'Mobile Usage',
      value: status.violations.mobileUsage,
      icon: Smartphone,
      color: 'text-red-600 bg-red-100',
    },
    {
      label: 'Person Issues',
      value: status.violations.multiplePerson + status.violations.noPerson,
      icon: Users,
